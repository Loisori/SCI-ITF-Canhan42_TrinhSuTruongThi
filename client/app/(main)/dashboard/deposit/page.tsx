    ...
    <div className="bg-background-light dark:bg-background-dark min-h-screen font-display">
      ...
      <main className="wrapper wrapper--sm py-12">
        ...
        <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-xl">
          Quy trình nạp tiền tuân thủ điều kiện an toàn và chuẩn xác thức eKYC.
          Số tiền sẽ tự động trừ phí và cộng dồn vào ví của bạn sau khi hoàn
          tất.
        </p>

        <form
          onSubmit={handleDeposit}
          className="bg-white dark:bg-slate-900 rounded-5 border border-slate-200 dark:border-slate-800 shadow-sm p-8 space-y-8"
        >
          {/* Amount Selection */}
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-smaller text-slate-500 mt-1">
                  Quét mã QR, Thẻ ATM nội địa, Thẻ quốc tế Visa/Mastercard.
                </p>
              </div>

              {/* Bank Transfer Option - Disabled mock */}
              <div className="flex flex-col p-5 rounded-xl border-2 border-slate-200 dark:border-slate-700 opacity-60 cursor-not-allowed bg-slate-50 dark:bg-slate-800/50">
                <div className="flex items-start justify-between mb-2">
                ...
                <p className="text-smaller text-slate-500 mt-1">
                  Hệ thống chuyển khoản ngân hàng đang được chúng tôi nâng cấp.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-smaller text-slate-500 mt-1">
                  Hỗ trợ giao dịch nhanh và an toàn trực tiếp qua ví MoMo.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 text-center bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 rounded-xl text-smaller text-slate-500 flex items-center justify-center gap-2">
          ...
          Giao dịch được mã hóa 256-bit và bảo mật bởi ngân hàng nhà nước Việt
          Nam.
        </div>
      </main>
      <Footer />
