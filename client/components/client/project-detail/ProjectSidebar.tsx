...
export default function ProjectSidebar() {
  ...
  return (
    <aside className="space-y-6 lg:sticky lg:top-24 font-display">
      <div className="bg-white dark:bg-slate-800 border-2 border-primary/10 rounded-5 p-6 shadow-xl">
        <div className="mb-6">
          <p className="text-slate-500 text-smaller font-medium mb-1">
            Đầu tư tối thiểu
          </p>
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-smallest text-slate-500 font-medium mb-1">
                Lợi nhuận dự kiến
              </p>
